...
const routes: Routes = [
  {
    path: 'action-menu',
    loadChildren: () => import('./action-menu/action-menu-example.module').then(t => t.ActionMenuExampleModule)
  },
  {path: 'button', loadChildren: () => import('./button/button-example.module').then(t => t.ButtonExampleModule)},
  {
    path: 'form-field',
    loadChildren: () => import('./form-field/form-field-example.module').then(t => t.FormFieldExampleModule)
  },
  {
    path: 'description-list',
    loadChildren: () => import('./description-list/description-list-example.module').then(t => t.DescriptionListExampleModule)
  },
  ...
  {
    path: 'checkbox',
    loadChildren: () => import('./checkbox/checkbox-example.module').then(t => t.CheckboxExampleModule)
  },
  ...
  {
    path: 'selection',
    loadChildren: () => import('./selection/selection-example.module').then(t => t.SelectionExampleModule)
  },
  {path: 'table', loadChildren: () => import('./table/table-example.module').then(t => t.TableExampleModule)},
  {
    path: 'paginator',
    loadChildren: () => import('./paginator/paginator-example.module').then(t => t.PaginatorExampleModule)
  },
  ...
  {
    path: 'dropdown',
    loadChildren: () => import('./dropdown/dropdown-example.module').then(t => t.DropdownExampleModule)
  },
  {
    path: 'context-menu',
